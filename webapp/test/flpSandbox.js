		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#compracticenorthwind-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"compracticenorthwind-display": {
								"semanticObject": "compracticenorthwind",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.practice.northwind",
									"url": sap.ui.require.toUrl("com/practice/northwind")
								}
							}
						}
					}
