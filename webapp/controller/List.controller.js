sap.ui.define([
    ...
    return BaseController.extend("com.practice.northwind.controller.List", {
        ...
        onInit : function () {
            ...
            this._oGroupFunctions = {
                EmployeeID: function(oContext) {
                    var iNumber = oContext.getProperty('EmployeeID'),
                        key, text;
                    if (iNumber <= 20) {
                        key = "LE20";
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "com.practice.northwind.view.ViewSettingsDialog",
                    controller: this
